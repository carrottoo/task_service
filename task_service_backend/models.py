...
class Property(models.Model):
    ...
    creator = models.ForeignKey(
        User, on_delete=models.CASCADE, related_name="created_properties"
    )
...
class TaskProperty(models.Model):
    ...
    task = models.ForeignKey(
        Task, on_delete=models.CASCADE, related_name="task_properties"
    )  # null=False is the default
...
class UserProperty(models.Model):
    ...
    user = models.ForeignKey(
        User, on_delete=models.CASCADE, related_name="user_properties"
    )
    property = models.ForeignKey(Property, on_delete=models.CASCADE)
...
class UserBehavior(models.Model):
    ...
    user = models.ForeignKey(
        User, on_delete=models.CASCADE, related_name="user_behaviors"
    )
    task = models.ForeignKey(
        Task, on_delete=models.CASCADE, related_name="task_behaviors"
    )
